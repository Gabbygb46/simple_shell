 ...
 * @head: assign of pointer to head node
 * @str: string field of node
 * @num: index node used by history
 *
 * Return: size of list
 ...
 * @head: from address of pointer to first node
 * @index: to delete index of node
 *
 ...
 * @head_ptr: from address of pointer to head node
 *
 * Return: void
 */
